//--Shell Sort--:it is a variation to insertion sort
//--the shell sort first sorts elements situated at h places apart for each element
...
//--Comb Sort--:the Comb sort is a variation to bubble sort like shell sort is to insertion sort (same in comb 
//--sort we sort h-sorted subarrays like in shell sort)
